                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-ru" role="tabpanel" aria-labelledby="nav-ru-tab">
                        <div class="mt-3">
                            ...
                            <textarea class="form-control"  rows="3" id="about_ru" placeholder="@lang('admin.body')" name="body[ru]">{!! $contact->body['ru'] !!}</textarea>
                    ...
                    <div class="tab-pane fade" id="nav-uz" role="tabpanel" aria-labelledby="nav-uz-tab">
                        <div class="mt-3">
                            <label class="mt-2">@lang('admin.body')</label>
                            <textarea class="form-control"  rows="3" id="about_uz" placeholder="@lang('admin.body')" name="body[uz]">{!! $contact->body['uz'] !!}</textarea>
                        </div>
